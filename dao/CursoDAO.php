<?php
	...
	class CursoDAO {
		...
		public function listar() {
			$query = "SELECT cur.*, cat.nome as categoria_nome, u.nome as usuario_criacao_nome
                        FROM curso cur 
                        LEFT JOIN categoria cat ON cur.id_categoria = cat.id
                        LEFT JOIN usuario u ON cur.id_usuario_criacao = u.id
                        ";
